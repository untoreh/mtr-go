...
func main() {
	...
	str := `\"How wondrous familiar is a fool!\" muttered Ahab; then aloud, \"Thou art a full ship and homeward bound, thou sayst; well, then, call me an empty ship, and outward-bound.
	...
	//eh := txtrq.SplitP(&str, &txtrq.RgxMain);
	//thefu := txtrq.SplitP(&str, &txtrq.RgxMain)
	//tools.Lc.Convert("ger")
